...
package land.arisu.tsubaki.core.playground

object PlaygroundRenderer {
    fun render(): String = """
        <!DOCTYPE html>
        <html>
            <head>
                <title>Tsubaki &bull; Playground</title>
                <meta charset="UTF-8" />
            ...
            <body>
                <div id="root">
                    ...
                    <img src='https://cdn.floofy.dev/images/trans.png' alt='trans heart' />
                    <div class="loading">
                        <span class="title">Tsubaki | GraphQL IDE</span>
                    </div>
                </div>

                <script defer>
                    GraphQLPlayground.init(document.getElementById('root'), {
                        endpoint: "http://localhost:28093/graphql",

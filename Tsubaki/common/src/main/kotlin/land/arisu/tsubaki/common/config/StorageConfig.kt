...
import land.arisu.tsubaki.common.config.storage.*

/**
 * The storage configuration details, you are not allowed
 * to have multiple.
 */
@Serializable
data class StorageConfig(
    /**
     * Filesystem config details
     */
    ...
    /**
     * Amazon S3 or Wasabi storage details
     */
